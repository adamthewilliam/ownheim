...
| 0002 | [team-middleware](./0002-team-middleware.md) | 4 framework adapters re-implementing `runWithOwner`-wrapping middleware | `@strays/runtime/withOwnerScope` (originally `withTeamScope`; renamed for naming consistency) |
